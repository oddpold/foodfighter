...
public class SearchlocalDto {
	...
	private int rest_idx,menuprice,revscore,cnt,review_cnt,menu_cnt;
	...
	private String resscore,image,name,addr1,addr2,region1,region2,tel,ftype,rangeprice,parking,runtime,lastorder,holiday,breaktime,homepage,regdate,menu,content;
