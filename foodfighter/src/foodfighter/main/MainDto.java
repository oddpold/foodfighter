...
public class MainDto {
	...
	private int rest_idx,user_idx,review_idx,menuprice,cnt;
	...
	private String nickname,userscore,revscore,resscore,image,imglist,name,addr1,addr2,region1,region2,tel,ftype,rangeprice,parking,runtime,lastorder,holiday,breaktime,homepage,regdate,menu,content;
